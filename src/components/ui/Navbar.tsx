...
export default function Navbar() {
  return (
    <div className='w-full pt-15 pb-15 h-20 border-b-[1px] border-gray-500 text-white item-center'>
    <div className='gap-10 max-w-screen-2xl h-full mx-auto px-20 flex items-center justify-between'>
        <Link href='./' className='flex  gap-2 justify-between items-center'>
           <Image src='/Image/Logo1.png' alt='suffer' width={100} height={100} />
            <h1 className='text-2xl font-extrabold text-blue-900'>SmartInk</h1>
        </Link>
        <div>
